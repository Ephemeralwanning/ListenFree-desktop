...
$fixture = Join-Path $repo 'build/editor-modal-check'
...
Copy-Item -LiteralPath (Join-Path $repo 'music_player_desktop/pages/MusicEditorDialog.qml') -Destination (Join-Path $fixture 'pages') -Force
Copy-Item -LiteralPath (Join-Path $repo 'tests/qml/tst_editor_modal.qml') -Destination $fixture -Force
